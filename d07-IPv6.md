...
每个16位字段，由4个十六进制字符表示，那么每个字符就表示了4位。每个16为十六进制字段，可以是0x0000和0xFFFF之间的值，但就如同今天后面讲到的那样，__前十六位中一些数值已被保留，那么所有可能的数值都不被使用__。在写IPv6地址时，__十六进制字符不区分大小写__。也就是说，2001:ABCD:0000和2001:abcd:0000是完全一样的。IPv6地址表示法的完整形式，在下图7.4中有演示。
...
压缩的表示法，允许以两种压缩方式之一，对IPv6地址进行压缩。第一种压缩方式，允许使用__一对__冒号（::）, 对一个有效IPv6地址中的那些由0s构成的连续16位字段的连续的0值，或者IPv6地址中的前导0s，进行压缩。在使用这种方式时，务必要记住，双冒号在一个IPv6地址中，只能使用一次。
...
<tr><td>0000:0000:0000:0000:0000:0000:0000:0001</td><td>::0001</td></tr>
<tr><td>2001:0000:0000:1234:0000:5678:af23:bcd5</td><td>2001::1234:0:5678:af23:bcd5</td></tr>
<tr><td>3FFF:0000:0000:1010:1A2B:5000:0B00:DE0F</td><td>3FFF::1010:1A2B：5000:B00:DE0F</td></tr>
<tr><td>FEC0:2004:AB10:00CD:1234:0000:0000:6789</td><td>FEC0:2004:AB10:CD:1234::6789</td></tr>
<tr><td>0000:0000:0000:0000:0000:FFFF:172.16.255.1</td><td>::FFFF:172.16.255.1</td></tr>
<tr><td>0000:0000:0000:0000:0000:0000:172.16.255.1</td><td>::172.16.255.1</td></tr>
<tr><td>0000:0000:0000:0000:0000:0000:0000:0000</td><td>::</td></tr>
</table>
